...
<head>
	...
	<!-- 다음 주소 API 끝 -->
	<!-- join_form_cs.css style 파일 -->
	<link rel="stylesheet" type="text/css" href="./resources/css/join/join_form_cs.css">
	<!-- join_form_cs.css style 파일 -->
</head>
<body>
<!-- header zone -->
...
<!-- join_form_cs.js 파일 -->
<script type="text/javascript" src="./resources/js/join/join_form_cs.js"></script>
<!-- join_form_cs.js 파일 -->
</body>
</html>