...
<head>
	...
	<!-- alert창 API 끝 -->
	<!-- join_form_cs_category.css style 파일 -->
	<link rel="stylesheet" type="text/css" href="./resources/css/join/join_form_cs_category.css">
	<!-- join_form_cs_category.css style 파일 -->
</head>
<body>
<!-- header zone -->
...
<!-- join_form_cs_category.js 파일 -->
<script type="text/javascript" src="./resources/js/join/join_form_cs_category.js"></script>
<!-- join_form_cs_category.js 파일 -->
</html>